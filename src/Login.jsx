    ...
    <div className='flex flex-col justify-center items-center h-[100vh] lg:flex-row '>
      ...
      <div className='w-[100%] h-[70vh] p-4 bg-gray-400 flex flex-col justify-center items-center lg:h-full'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='w-[50%]'>
          ...
          <div>
            <button className='bg-bluishGreen-100 px-4 py-2 mt-2 rounded-md text-white text-lg hover:text-bluishGreen-100 hover:bg-white'>Submit</button>
          </div>
        </form>
        <h2 className='text-[#344055] my-4 text-2xl relative ele-after'><span className='font-bold'>Login</span> with others</h2>
        <div className='px-6 py-4 border border-gray-1000 rounded-lg flex cursor-pointer'>
          ...
          <h4>Login with <span className='font-bold'>GOOGLE</span></h4>
        </div>
      </div>
    </div>
  )
